...
save(Bac.seq, file = "/Users/smatsuda/Library/CloudStorage/OneDrive-SheddAquariumSociety/Projects/Fluconazole/Fluconazole/RData/Bac.seqFLU.RData")
```
...
# Filter out samples with fewer than 1500 reads
Bac.seq.S.2 <- prune_samples(sample_sums(Bac.seq.S.2) >= 1500, Bac.seq.S.2)
